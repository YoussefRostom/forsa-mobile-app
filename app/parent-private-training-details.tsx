...
export default function ParentPrivateTrainingDetailsScreen() {
  ...
  const handleBookPrivateTraining = async () => {
    ...
    try {
      ...
      let parentName = user.displayName || (i18n.t('parent') || 'Parent');
      try {
      ...
      >
        <Animated.View style={{ flex: 1, opacity: fadeAnim }}>
          ...
          >
            ...
            <TouchableOpacity
              style={[styles.reserveButton, (sendingPrivateBooking || academySuspended) && styles.reserveButtonDisabled]}
              onPress={handleBookPrivateTraining}
              activeOpacity={0.8}
              disabled={sendingPrivateBooking || academySuspended}
            >

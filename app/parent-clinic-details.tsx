        ...
        <Animated.View style={{ flex: 1, opacity: fadeAnim }}>
          ...
          >
            ...
            <View style={styles.bookingCard}>
              ...
              <TouchableOpacity
                style={[styles.reserveButton, (bookingLoading || !selectedShift || !resolvedPreferredTime || clinicSuspended) && styles.reserveButtonDisabled]}
                onPress={() => handleReserve()}
                disabled={bookingLoading || !clinic.services || clinic.services.length === 0 || !selectedShift || !resolvedPreferredTime || clinicSuspended}
                activeOpacity={0.8}
              >
                {bookingLoading ? (
